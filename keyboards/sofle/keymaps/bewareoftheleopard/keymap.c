 ...
 * | LCTRL|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   \  |   /  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Lalt | LGUI | Layer |Space| /  BkSp /       \ Tab \  |Return| Layer | RGUI |   #  |
 *            |      |      |  1   |      |/       /         \      \ |      |   2  |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_MUTE,   KC_NO, KC_N,    KC_M,   KC_COMM,  KC_DOT,  KC_SLSH,  KC_NUHS,
                   KC_LALT,   KC_LGUI, MO(1),   KC_SPC,  KC_BSPC,             KC_TAB,   KC_ENT, MO(2), KC_LGUI, KC_GRV
    ),
